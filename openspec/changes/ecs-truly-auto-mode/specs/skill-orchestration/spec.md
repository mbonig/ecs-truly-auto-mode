...
The system SHALL detect an existing manifest in the target repository and resume from the recorded state rather than restarting, preserving prior decisions.
