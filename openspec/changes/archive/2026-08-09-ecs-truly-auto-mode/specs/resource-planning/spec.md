...
The system SHALL derive from the analysis findings a complete list of every AWS resource the application needs to run, and SHALL present that list to the user before generating any infrastructure code.
